...
// Pagination
const totalPages = Math.ceil(allTopSelling.length / itemsPerPage);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">📈 Top 5 Best Sellers</h2>
              ...
              {insights.topSelling.map((item, index) => (
                <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <p className="font-bold text-purple-600">₹{item.revenue.toFixed(0)}</p>
